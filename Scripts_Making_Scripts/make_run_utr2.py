...
for i in sim_num:
    ...
    write_header(out)
    out.write('#Filter WGS, SpecSup250\nspec_mat="PhyloP/SpeciesMatrix_PhyloP_FiltWGS_3UTR_PhyloP-100_SpecSup250_YCM_NCV_Per0"\nback_mat="PhyloP/BackgroundMatrix_FiltWGS_PhyloP_3UTR_PhyloP-100_SpecSup250_NCM_Per0"\n')
    out.write("python simulate_new_humchp.py HumChp_AccelEvolInput.Final.txt 1 -100 250 0 1 0 0 3UTR Outputs/PhyloP_3UTR_FiltWGS_PhyloP-100_SpecSup250_YCM_NCV_Per0_PerGene_HPO PhyloP447 PhyloP447 $spec_mat $back_mat " + ",".join([str(i - 10000), str(i)]) + " /home/groups/hbfraser/astarr_scripts/AccelConv/GeneSets/HPO_AccelEvol_Input_FiltForAccelEvol.txt,15,100\n")
    out.close()

    out = open("run_3utr_paramset4_hpo_" + str(i - 10000) + "-" + str(i) + ".sh", 'w')
    write_header(out)
    out.write('#Not filtering WGS, SpecSup250\nspec_mat="PhyloP/SpeciesMatrix_PhyloP_NoFiltWGS_3UTR_PhyloP-100_SpecSup250_YCM_NCV_Per0"\nback_mat="PhyloP/BackgroundMatrix_NoFiltWGS_PhyloP_3UTR_PhyloP-100_SpecSup250_NCM_Per0"\n')
    out.write("python simulate_new_humchp.py HumChp_AccelEvolInput.Final.txt 0 -100 250 0 1 0 0 3UTR Outputs/PhyloP_3UTR_NoFiltWGS_PhyloP-100_SpecSup250_YCM_NCV_Per0_PerGene_HPO PhyloP447 PhyloP447 $spec_mat $back_mat " + ",".join([str(i - 10000), str(i)]) + " /home/groups/hbfraser/astarr_scripts/AccelConv/GeneSets/HPO_AccelEvol_Input_FiltForAccelEvol.txt,15,100\n")
    out.close()
    
    out = open("run_3utr_paramset3_gobp_" + str(i - 10000) + "-" + str(i) + ".sh", 'w')
    write_header(out)
    out.write('#Filter WGS, SpecSup250\nspec_mat="PhyloP/SpeciesMatrix_PhyloP_FiltWGS_3UTR_PhyloP-100_SpecSup250_YCM_NCV_Per0"\nback_mat="PhyloP/BackgroundMatrix_FiltWGS_PhyloP_3UTR_PhyloP-100_SpecSup250_NCM_Per0"\n')
    out.write("python simulate_new_humchp.py HumChp_AccelEvolInput.Final.txt 1 -100 250 0 1 0 0 3UTR Outputs/PhyloP_3UTR_FiltWGS_PhyloP-100_SpecSup250_YCM_NCV_Per0_PerGene_GOBP PhyloP447 PhyloP447 $spec_mat $back_mat " + ",".join([str(i - 10000), str(i)]) + " /home/groups/hbfraser/astarr_scripts/AccelConv/GeneSets/GOBP_AccelEvol_Input_FiltForAccelEvol.txt,15,100\n")
    out.close()

    out = open("run_3utr_paramset4_gobp_" + str(i - 10000) + "-" + str(i) + ".sh", 'w')
    write_header(out)
    out.write('#Not filtering WGS, SpecSup250\nspec_mat="PhyloP/SpeciesMatrix_PhyloP_NoFiltWGS_3UTR_PhyloP-100_SpecSup250_YCM_NCV_Per0"\nback_mat="PhyloP/BackgroundMatrix_NoFiltWGS_PhyloP_3UTR_PhyloP-100_SpecSup250_NCM_Per0"\n')
    out.write("python simulate_new_humchp.py HumChp_AccelEvolInput.Final.txt 0 -100 250 0 1 0 0 3UTR Outputs/PhyloP_3UTR_NoFiltWGS_PhyloP-100_SpecSup250_YCM_NCV_Per0_PerGene_GOBP PhyloP447 PhyloP447 $spec_mat $back_mat " + ",".join([str(i - 10000), str(i)]) + " /home/groups/hbfraser/astarr_scripts/AccelConv/GeneSets/GOBP_AccelEvol_Input_FiltForAccelEvol.txt,15,100\n")
    out.close()
    
    out = open("run_5utr_paramset3_hpo_" + str(i - 10000) + "-" + str(i) + ".sh", 'w')
    write_header(out)
    out.write('#Filter WGS, SpecSup250\nspec_mat="PhyloP/SpeciesMatrix_PhyloP_FiltWGS_5UTR_PhyloP-100_SpecSup250_YCM_NCV_Per0"\nback_mat="PhyloP/BackgroundMatrix_FiltWGS_PhyloP_5UTR_PhyloP-100_SpecSup250_NCM_Per0"\n')
    out.write("python simulate_new_humchp.py HumChp_AccelEvolInput.Final.txt 1 -100 250 0 1 0 0 5UTR Outputs/PhyloP_5UTR_FiltWGS_PhyloP-100_SpecSup250_YCM_NCV_Per0_PerGene_HPO PhyloP447 PhyloP447 $spec_mat $back_mat " + ",".join([str(i - 10000), str(i)]) + " /home/groups/hbfraser/astarr_scripts/AccelConv/GeneSets/HPO_AccelEvol_Input_FiltForAccelEvol.txt,15,100\n")
    out.close()

    out = open("run_5utr_paramset4_hpo_" + str(i - 10000) + "-" + str(i) + ".sh", 'w')
    write_header(out)
    out.write('#Not filtering WGS, SpecSup250\nspec_mat="PhyloP/SpeciesMatrix_PhyloP_NoFiltWGS_5UTR_PhyloP-100_SpecSup250_YCM_NCV_Per0"\nback_mat="PhyloP/BackgroundMatrix_NoFiltWGS_PhyloP_5UTR_PhyloP-100_SpecSup250_NCM_Per0"\n')
    out.write("python simulate_new_humchp.py HumChp_AccelEvolInput.Final.txt 0 -100 250 0 1 0 0 5UTR Outputs/PhyloP_5UTR_NoFiltWGS_PhyloP-100_SpecSup250_YCM_NCV_Per0_PerGene_HPO PhyloP447 PhyloP447 $spec_mat $back_mat " + ",".join([str(i - 10000), str(i)]) + " /home/groups/hbfraser/astarr_scripts/AccelConv/GeneSets/HPO_AccelEvol_Input_FiltForAccelEvol.txt,15,100\n")
    out.close()

    out = open("run_5utr_paramset3_gobp_" + str(i - 10000) + "-" + str(i) + ".sh", 'w')
    write_header(out)
    out.write('#Filter WGS, SpecSup250\nspec_mat="PhyloP/SpeciesMatrix_PhyloP_FiltWGS_5UTR_PhyloP-100_SpecSup250_YCM_NCV_Per0"\nback_mat="PhyloP/BackgroundMatrix_FiltWGS_PhyloP_5UTR_PhyloP-100_SpecSup250_NCM_Per0"\n')
    out.write("python simulate_new_humchp.py HumChp_AccelEvolInput.Final.txt 1 -100 250 0 1 0 0 5UTR Outputs/PhyloP_5UTR_FiltWGS_PhyloP-100_SpecSup250_YCM_NCV_Per0_PerGene_GOBP PhyloP447 PhyloP447 $spec_mat $back_mat " + ",".join([str(i - 10000), str(i)]) + " /home/groups/hbfraser/astarr_scripts/AccelConv/GeneSets/GOBP_AccelEvol_Input_FiltForAccelEvol.txt,15,100\n")
    out.close()

    out = open("run_5utr_paramset4_gobp_" + str(i - 10000) + "-" + str(i) + ".sh", 'w')
    write_header(out)
    out.write('#Not filtering WGS, SpecSup250\nspec_mat="PhyloP/SpeciesMatrix_PhyloP_NoFiltWGS_5UTR_PhyloP-100_SpecSup250_YCM_NCV_Per0"\nback_mat="PhyloP/BackgroundMatrix_NoFiltWGS_PhyloP_5UTR_PhyloP-100_SpecSup250_NCM_Per0"\n')
    out.write("python simulate_new_humchp.py HumChp_AccelEvolInput.Final.txt 0 -100 250 0 1 0 0 5UTR Outputs/PhyloP_5UTR_NoFiltWGS_PhyloP-100_SpecSup250_YCM_NCV_Per0_PerGene_GOBP PhyloP447 PhyloP447 $spec_mat $back_mat " + ",".join([str(i - 10000), str(i)]) + " /home/groups/hbfraser/astarr_scripts/AccelConv/GeneSets/GOBP_AccelEvol_Input_FiltForAccelEvol.txt,15,100\n")
    out.close()
